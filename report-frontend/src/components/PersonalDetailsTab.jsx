    ...
    {classOptions.map((option) => (
      ...
      <div className="flex flex-col">
        ...
        {informant === "other" && (
          <input
            ...
            {...register("informantOther", { required: informant === "other" })}
            autoComplete="off"
          />
        )}  
        </div>
      ...
      <div className="flex flex-col">
        ...
        <select
          ...
          <option value="Johnson Grammer School">Johnson Grammer School</option>
          <option value="Delhi Public School">Delhi Public School</option>
          <option value="Suprabath Public School">Suprabath Public School</option>
          <option value="St. Patriks Academy">St. Patriks Academy</option>
          <option value="Slate the school">Slate the school</option>
          <option value="other">Other</option>
          </select>
          {school === "other" && (
            <input
              ...
              {...register("schoolOther", { required: school === "other" })}
              autoComplete="off"
            />
          )}
      </div>
